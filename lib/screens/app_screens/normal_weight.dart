...
class NormalWeight extends StatefulWidget {
  final String bmi;
  const NormalWeight({super.key, required this.bmi});

  @override
  State<NormalWeight> createState() => _NormalWeightState();
}
        ...
        children: [
          ...
          TextButton(
              ...
              style: TextButton.styleFrom(
                ...
                backgroundColor: AppColors.primaryColors.green,
              ),
              child: Text(
                "NormalWeight",
                style: TextStyle(
          ...
          Padding(
            ...
            child: Text(
              "👍 Thumbs Up! You've done a great job and now only need to maintain your healty lifestyle to stay in this range",
              style: TextStyle(
                  fontSize: 17,
